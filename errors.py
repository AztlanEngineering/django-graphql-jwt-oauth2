...
def ObscureHttpResponse(reason: str = DEFAULT_ERROR_MESSAGE, code: int = DEFAULT_STATUS_CODE) -> HttpResponse:
    """
    ...
    """
    return HttpResponse(reason if settings.DEBUG else DEFAULT_ERROR_MESSAGE, status=code)
